...
namespace ProyectoSanoCenter.Controllers
{
    public class EjerciciosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,NombreEjercicio,Demostracion")] Ejercicio ejercicio)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,NombreEjercicio,Demostracion")] Ejercicio ejercicio)
        {
            if (id != ejercicio.Id)
            {
                return NotFound();
